...
def add_preparation_args(parser):
    ...
    group.add_argument(
        ...
        type = str,
        default = None,
        help='Dict defining the datasets to process')
...
def add_feature_filtering_args(parser):
    ...
    group.add_argument(
        '--data_table_path',
        type=str,
        help='Path to data table CSV file with dector aggregated spots'
    )

    group.add_argument(
        '--data_table_path_main',
        type=str,
        help='Path to data table CSV file with all spots'
    )
...
def add_external_validation_args(parser):
    ...
    group.add_argument(
        '--prediction_plot_path_validation',
        type=str,
        help='Path to the plot predcited vs actual range shift',
        required = True
        )
