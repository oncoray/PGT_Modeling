...
# from pmma.mirp.contourClass import ContourClass
from pmma.mirp.imageClass import ImageClass
from pmma.mirp.imageMetaData import get_pydicom_meta_tag, set_pydicom_meta_tag
...
class RoiClass:
    ...
    def interpolate(self, img_obj, settings):
        ...
        if settings.img_interpolate.anti_aliasing:
            from pmma.mirp.imageProcess import gaussian_preprocess_filter
    ...
    def dilate(self, by_slice, dist=None, vox_dist=None):
        from pmma.mirp.featureSets.utilities import rep
