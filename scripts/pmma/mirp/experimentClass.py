# from pmma.mirp.configThreading import disable_multi_threading
...
from pmma.mirp.utilities import expand_grid
...
class ExperimentClass:
    ...
    def get_roi_list(self):
        ...
        import logging
        from pmma.mirp.imageRead import find_regions_of_interest
    ...
    def get_imaging_parameter_table(self):
        ...
        import logging
        from pmma.mirp.imageRead import find_imaging_parameters
    ...
    def get_file_structure_information(self, include_path_info=False):
        ...
        from pmma.mirp.imageMetaData import get_image_directory_meta_data
    ...
    def process(self):
        ...
        import os
        import logging
        from pmma.mirp.imageRead import load_image
        from pmma.mirp.imageProcess import crop_image, estimate_image_noise, interpolate_image,\
        ...
        from pmma.mirp.imagePerturbations import rotate_image, adapt_roi_size, randomise_roi_contours
        import copy
    ...
    def process_deep_learning(self,
        ...
        import logging
        from pmma.mirp.imageRead import load_image
        from pmma.mirp.imageProcess import estimate_image_noise, interpolate_image, interpolate_roi, crop_image_to_size, saturate_image, normalise_image
        from pmma.mirp.imagePerturbations import rotate_image, adapt_roi_size, randomise_roi_contours
        from pmma.mirp.roiClass import merge_roi_objects
        import copy
