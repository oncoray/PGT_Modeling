...
from pmma.mirp.importSettings import SettingsClass
from pmma.mirp.imageClass import ImageClass
...
def transform_images(img_obj, roi_list, settings, compute_features=False, extract_images=False, file_path=None):
    ...
    for curr_filter in spatial_filter:
        ...
        if curr_filter == "wavelet":
            # Wavelet filters
            from pmma.mirp.imageFilters.waveletFilter import WaveletFilter
            ...
            from pmma.mirp.imageFilters.laplacianOfGaussian import LaplacianOfGaussianFilter
            ...
            # Laws' kernels
            from pmma.mirp.imageFilters.lawsFilter import LawsFilter
            ...
            # Mean / uniform filter
            from pmma.mirp.imageFilters.meanFilter import MeanFilter
...
def calculate_features(img_obj, roi_list, settings, append_str=""):
    ...
    from pmma.mirp.featureSets.localIntensity import get_local_intensity_features
    from pmma.mirp.featureSets.statistics import get_intensity_statistics_features
    from pmma.mirp.featureSets.intensityVolumeHistogram import get_intensity_volume_histogram_features
    from pmma.mirp.featureSets.volumeMorphology import get_volumetric_morphological_features
...
def compute_discretised_features(img_obj, roi_obj, settings, discr_method="none", bin_width=None, bin_number=None):
    ...
    from pmma.mirp.featureSets.intensityHistogram import get_intensity_histogram_features
    from pmma.mirp.featureSets.cooccurrenceMatrix import get_cm_features
    from pmma.mirp.featureSets.runLengthMatrix import get_rlm_features
    from pmma.mirp.featureSets.sizeZoneMatrix import get_szm_features
    from pmma.mirp.featureSets.distanceZoneMatrix import get_dzm_features
    from pmma.mirp.featureSets.neighbourhoodGreyToneDifferenceMatrix import get_ngtdm_features
    from pmma.mirp.featureSets.neighbouringGreyLevelDifferenceMatrix import get_ngldm_features
