...
from pmma.mirp.featureSets.utilities import get_neighbour_directions, is_list_all_none, coord2Index, get_intensity_value, rep
...
class GreyToneDifferenceMatrix:
    ...
    def calculate_matrix(self, df_img, img_dims):
        ...
        df_ngtdm = df_ngtdm.drop(
            labels=["index_id", "x", "y", "z", "g_sum", "n_nbrs", "to_index", "to_g", "g_nbr_avg", "roi_int_mask"], axis=1)
