...
from pmma.mirp.imageMetaData import get_pydicom_meta_tag, set_pydicom_meta_tag, create_new_uid
from pmma.mirp.utilities import get_version
...
class ImageClass:
    ...
    def interpolate(self, by_slice, settings):
        ...
        from pmma.mirp.imageProcess import interpolate_to_new_grid, gaussian_preprocess_filter
    ...
    def rotate(self, angle):
        ...
        from pmma.mirp.featureSets.volumeMorphology import get_rotation_matrix
    ...
    #     from pmma.mirp.imageProcess import interpolate_to_new_grid
    #
    #     # Skip for missing images
    #     if self.is_missing:
    #         return
    ...
    def crop(self, ind_ext_z=None, ind_ext_y=None, ind_ext_x=None,
        ...
        from pmma.mirp.utilities import world_to_index
